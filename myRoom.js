...
function myRoom(room, roomHandler) {
	this.room = room;
...
myRoom.prototype.populate = function() {
...
myRoom.prototype.loadCreeps = function() {
...
myRoom.prototype.distributeBuilders = function() {
...
myRoom.prototype.distributeCarriers = function() {
	var counter = 0;
	var builders = [];
	var carriers = [];
	for(var i = 0; i < this.creeps.length; i++) {
...
myRoom.prototype.distributeResources = function(type) {
